...
class SiteRichContentRenderer
{
    ...
    private static function replaceYouTubeMarkers(string $html): string
    {
        ...
        $document->loadHTML(
            '<?xml encoding="UTF-8"><div id="site-rich-content-root">'.$html.'</div>',
        ...
        $root = $document->getElementById('site-rich-content-root');
    ...
    private static function createYouTubeEmbed(DOMDocument $document, string $videoId): DOMElement
    {
        ...
        $wrapper->setAttribute('class', 'site-youtube-video');
