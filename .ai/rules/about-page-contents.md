...
AboutPageContent.text is edited with Filament RichEditor, stores attachments on the public disk under about/content, and supports the shared YouTube custom block. AboutPageContent.text2 remains plain textarea unless explicitly changed.
